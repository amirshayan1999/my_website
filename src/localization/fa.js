const info = {
  ...
  hi2: " هستم",
  homeDesc:
    "  برنامه نویس و توسعه دهنده سمت کاربر اممم ساری باید متن طولانی تری بنویسم بعدا فکر میکنم یه متن طولانی درست و حسابی مینوسیم ولی خب در حال حاضر همین خوبه",
  aboutMe: "معرفی",
  fullName: "نام کامل",
  age: "سال",
  nationality: "ملیت",
  ...
  jobFirstDesc:
    "Game presenter in bordar group, I have mastered a lot of board games and I can win all of you ",
  jobSecondYear: "1400 - حال",
  jobSecondTitle: "توسعه دهنده سمت کاربر",
  jobSecondCompany: "شرکت عدل آفرینان ماندگار",
  jobSecondDesc:
    "Frontend developer at Adl Afarinan Mandegar, I'm still learning so I don't know what to say in this section bluh bluh bluh as usual",
